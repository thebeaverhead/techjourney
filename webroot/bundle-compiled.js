 ...
 * Created by piotr.pozniak@thebeaverhead.com on 30/10/2017.
 */// Initialize Firebase
exports.default={apiKey:"AIzaSyASMmIwUjVnWGiHC56lZt5no9otvA58tnQ",authDomain:"stackoverview.firebaseapp.com",databaseURL:"https://stackoverview.firebaseio.com",projectId:"stackoverview",storageBucket:"",messagingSenderId:"75255022911"};},{}],2:[function(require,module,exports){'use strict';var _journey=require('./journey');var _journey2=_interopRequireDefault(_journey);var _ui=require('./ui');var _ui2=_interopRequireDefault(_ui);var _firebaseConfig=require('./firebase-config');var _firebaseConfig2=_interopRequireDefault(_firebaseConfig);var _jquery=require('jquery');var _jquery2=_interopRequireDefault(_jquery);var _hammerjs=require('hammerjs');var _hammerjs2=_interopRequireDefault(_hammerjs);var _isemail=require('isemail');var _isemail2=_interopRequireDefault(_isemail);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}/**
 * Created by piotr.pozniak@thebeaverhead.com on 19/10/2017.
 */console.log('hello tech journey');var app={};/**
 ...
 *
 */(0,_jquery2.default)(document).ready(function(){app.ui=new _ui2.default({onDescriptionChange:updateDescription});firebase.initializeApp(_firebaseConfig2.default);var canvas=document.getElementById('cvs');var levelRange=canvas.width>canvas.height?600:500;var zoomLevel=canvas.width>canvas.height?500:400;var levelThreshold=canvas.width>canvas.height?50:50;var zoomFactor=canvas.width>canvas.height?0.45:0.23;var imgResizeFactor=canvas.width>canvas.height?0.001:0.0009;var lang=navigator.language;var langSelected=false;(0,_jquery2.default)('.lang-btn').each(function(i,e){if((0,_jquery2.default)(e).val()==lang){(0,_jquery2.default)(e).addClass('active');langSelected=true;}});if(!langSelected){lang='en-UK';(0,_jquery2.default)(".lang-btn[value='en-UK']").addClass('active');}app.ui.journey=new _journey2.default({canvas:canvas,levelRange:levelRange,//$('#levelRange').val() * 1,
...
hammer.get('pinch').set({enable:true});hammer.get('swipe').set({direction:_hammerjs2.default.DIRECTION_VERTICAL});/**
   ...
   *
   */function onWindowResize(){(0,_jquery2.default)('#cvs').css('width',window.innerWidth);(0,_jquery2.default)('#cvs').css('height',window.innerHeight);app.ui.updateCanvasSize(window.innerWidth,window.innerHeight);};});},{"./firebase-config":1,"./journey":3,"./ui":4,"hammerjs":8,"isemail":10,"jquery":11}],3:[function(require,module,exports){'use strict';Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}/**
 * Created by piotr.pozniak@thebeaverhead.com on 19/10/2017.
...
for(var _j=0;_j<objts.length;_j++){this.renderItem(objts[_j],levelZoom,levelFromVisible*(highlightItemdX/levelFromVisible)-10,levelFromVisible*(highlightItemdY/levelFromVisible)-10,bgDX);}}}/**
     ...
     *
     * @returns {number}
     */},{key:'getCurrentLevel',value:function getCurrentLevel(){return Math.floor(this.zoomLevel/this.levelRange);}}]);return Journey;}();exports.default=Journey;},{}],4:[function(require,module,exports){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _createClass=function(){function defineProperties(target,props){for(var i=0;i<props.length;i++){var descriptor=props[i];descriptor.enumerable=descriptor.enumerable||false;descriptor.configurable=true;if("value"in descriptor)descriptor.writable=true;Object.defineProperty(target,descriptor.key,descriptor);}}return function(Constructor,protoProps,staticProps){if(protoProps)defineProperties(Constructor.prototype,protoProps);if(staticProps)defineProperties(Constructor,staticProps);return Constructor;};}();function _classCallCheck(instance,Constructor){if(!(instance instanceof Constructor)){throw new TypeError("Cannot call a class as a function");}}/**
...
if(extraBytes===1){tmp=uint8[len-1];output+=lookup[tmp>>2];output+=lookup[tmp<<4&0x3F];output+='==';}else if(extraBytes===2){tmp=(uint8[len-2]<<8)+uint8[len-1];output+=lookup[tmp>>10];output+=lookup[tmp>>4&0x3F];output+=lookup[tmp<<2&0x3F];output+='=';}parts.push(output);return parts.join('');}},{}],6:[function(require,module,exports){// shim for using process in browser
...
}},{"base64-js":5,"ieee754":9}],8:[function(require,module,exports){/*! Hammer.JS - v2.0.7 - 2016-04-22
...
cfwsComment:17,cfwsFWS:18,// Address contains deprecated elements, but may still be valid in some contexts
...
errExpectingDTEXT:129,errNoLocalPart:130,errNoDomain:131,errConsecutiveDots:132,errATEXTAfterCFWS:133,errATEXTAfterQS:134,errATEXTAfterDomainLiteral:135,errExpectingQPair:136,errExpectingATEXT:137,errExpectingQTEXT:138,errExpectingCTEXT:139,errBackslashEnd:140,errDotStart:141,errDotEnd:142,errDomainHyphenStart:143,errDomainHyphenEnd:144,errUnclosedQuotedString:145,errUnclosedComment:146,errUnclosedDomainLiteral:147,errFWSCRLFx2:148,errFWSCRLFEnd:149,errCRNoLF:150,errUnknownTLD:160,errDomainTooShort:161},components:{localpart:0,domain:1,literal:2,contextComment:3,contextFWS:4,contextQuotedString:5,contextQuotedPair:6}};internals.specials=function(){var specials='()<>[]:;@\\,."';// US-ASCII visible characters not valid for atext (http://tools.ietf.org/html/rfc5322#section-3.2.3)
...
for(var i=127;i<160;++i){lookup[i]=true;}return function(code){return lookup[code];};}();internals.regex={ipV4:/\b(?:(?:25[0-5]|2[0-4]\d|[01]?\d\d?)\.){3}(?:25[0-5]|2[0-4]\d|[01]?\d\d?)$/,ipV6:/^[a-fA-F\d]{0,4}$/};// $lab:coverage:off$
internals.nulNormalize=function(email){var emailPieces=email.split("\0");emailPieces=emailPieces.map(function(string){return string.normalize('NFC');});return emailPieces.join("\0");};// $lab:coverage:on$
internals.checkIpV6=function(items){return items.every(function(value){return internals.regex.ipV6.test(value);});};internals.validDomain=function(tldAtom,options){if(options.tldBlacklist){if(Array.isArray(options.tldBlacklist)){return internals.indexOf.call(options.tldBlacklist,tldAtom)===-1;}return!internals.hasOwn.call(options.tldBlacklist,tldAtom);}if(Array.isArray(options.tldWhitelist)){return internals.indexOf.call(options.tldWhitelist,tldAtom)!==-1;}return internals.hasOwn.call(options.tldWhitelist,tldAtom);};/**
 ...
 * @return {*}
 */exports.validate=internals.validate=function(email,options,callback){options=options||{};email=internals.normalize(email);if(typeof options==='function'){callback=options;options={};}if(typeof callback!=='function'){callback=null;}var diagnose=void 0;var threshold=void 0;if(typeof options.errorLevel==='number'){diagnose=true;threshold=options.errorLevel;}else{diagnose=!!options.errorLevel;threshold=internals.diagnoses.valid;}if(options.tldWhitelist){if(typeof options.tldWhitelist==='string'){options.tldWhitelist=[options.tldWhitelist];}else if(_typeof(options.tldWhitelist)!=='object'){throw new TypeError('expected array or object tldWhitelist');}}if(options.tldBlacklist){if(typeof options.tldBlacklist==='string'){options.tldBlacklist=[options.tldBlacklist];}else if(_typeof(options.tldBlacklist)!=='object'){throw new TypeError('expected array or object tldBlacklist');}}if(options.minDomainAtoms&&(options.minDomainAtoms!==(+options.minDomainAtoms|0)||options.minDomainAtoms<0)){throw new TypeError('expected positive integer minDomainAtoms');}var maxResult=internals.diagnoses.valid;var updateResult=function updateResult(value){if(value>maxResult){maxResult=value;}};var context={now:internals.components.localpart,prev:internals.components.localpart,stack:[internals.components.localpart]};var prevToken='';var parseData={local:'',domain:''};var atomData={locals:[''],domains:['']};var elementCount=0;var elementLength=0;var crlfCount=0;var charCode=void 0;var hyphenFlag=false;var assertEnd=false;var emailLength=email.length;var token=void 0;// Token is used outside the loop, must declare similarly
...
case'.':var punycodeLength=Punycode.encode(atomData.domains[elementCount]).length;if(elementLength===0){// Another dot, already? Fatal error.
...
case'[':if(parseData.domain.length===0){// Domain literal must be the only component
assertEnd=true;elementLength+=Buffer.byteLength(token,'utf8');context.stack.push(context.now);context.now=internals.components.literal;parseData.domain+=token;atomData.domains[elementCount]+=token;parseData.literal='';}else{// Fatal error
...
break;}}// Token loop
// Check for errors
if(maxResult<internals.categories.rfc5322){var _punycodeLength=Punycode.encode(parseData.domain).length;// Fatal errors
...
// labels   63 octets or less
updateResult(internals.diagnoses.rfc5322LabelTooLong);}else if(options.minDomainAtoms&&atomData.domains.length<options.minDomainAtoms){updateResult(internals.diagnoses.errDomainTooShort);}else if(options.tldWhitelist||options.tldBlacklist){var tldAtom=atomData.domains[elementCount];if(!internals.validDomain(tldAtom,options)){updateResult(internals.diagnoses.errUnknownTLD);}}}// Check for errors
// Finish
...
var code=atomData.domains[elementCount].codePointAt(0);if(code<=57){updateResult(internals.diagnoses.rfc5321TLDNumeric);}}if(maxResult<threshold){maxResult=internals.diagnoses.valid;}var finishResult=diagnose?maxResult:maxResult<internals.defaultThreshold;if(callback){callback(finishResult);}return finishResult;};exports.diagnoses=internals.validate.diagnoses=function(){var diag={};var keys=Object.keys(internals.diagnoses);for(var i=0;i<keys.length;++i){var key=keys[i];diag[key]=internals.diagnoses[key];}return diag;}();exports.normalize=internals.normalize=function(email){// $lab:coverage:off$
if(process.version[1]==='4'&&email.indexOf("\0")>=0){return internals.nulNormalize(email);}// $lab:coverage:on$
return email.normalize('NFC');};}).call(this,require('_process'),require("buffer").Buffer);},{"_process":6,"buffer":7,"punycode":12}],11:[function(require,module,exports){/*!
...
root.punycode=punycode;}})(this);}).call(this,typeof global!=="undefined"?global:typeof self!=="undefined"?self:typeof window!=="undefined"?window:{});},{}]},{},[2]);
